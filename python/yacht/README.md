# Yacht
这里的点在多种情况是用ifelse在一个函数里，还是用lambda来简化
两种情况我都实现了下，从效率上看，多个lambda会慢一些，看具体情况来取舍
...
## Scores in Yacht
    ...
    Ones            1 脳 number of ones      1 1 1 4 5 scores 3
    Twos            2 脳 number of twos      2 2 3 4 5 scores 4
    Threes          3 脳 number of threes    3 3 3 3 3 scores 15
    Fours           4 脳 number of fours     1 2 3 3 5 scores 0
    Fives           5 脳 number of fives     5 1 5 2 5 scores 15
    Sixes           6 脳 number of sixes     2 3 4 5 6 scores 6
